...
describe("Pengujian Fungsi Matematika", function () {
  ...
  it("seharusnya mengembalikan 6 saat melakukan menambahkan 6 + 2", function () {
    expect(tambah(6, 2)).to.equal(8);
  });

  it("seharusnya mengembalikan -8 saat melakukan pengurangan -3 - 5", function () {
    expect(kurang(-3, 5)).to.equal(-8);
  });
